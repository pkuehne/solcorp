...
[![Latest Release](https://img.shields.io/github/v/release/pkuehne/solcorp?include_prereleases&sort=semver)](https://github.com/pkuehne/solcorp/releases)
[![CI](https://img.shields.io/github/actions/workflow/status/pkuehne/solcorp/ci.yml?branch=main&label=ci)](https://github.com/pkuehne/solcorp/actions/workflows/ci.yml)
...
The game is so deeply in early Alpha, it's practically unplayable. But soon...
